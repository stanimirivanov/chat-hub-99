...
libs/application/profile/       Current-profile lookup/update port and use cases
libs/application/profile/       Current and batched profile-discovery use cases
...
libs/infrastructure/profile/    Supabase current-profile discovery adapter
