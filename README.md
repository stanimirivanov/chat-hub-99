...
libs/application/workspace/     Workspace discovery and membership administration workflows
...
libs/infrastructure/workspace/  Supabase workspace/member query and command adapter
