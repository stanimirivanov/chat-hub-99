...
creates the immutable run or reads its current lifecycle projection. A separate lease-fenced pair of commands
...
use case -> repository Tag -> Supabase Layer -> service-role RPC
         ...
         -> decoded current AnalysisRun, optional claim, or Analysis job
```
